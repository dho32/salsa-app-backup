...
part of 'scf_info_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class ScfInfoModelAdapter extends TypeAdapter<ScfInfoModel> {
  @override
  final int typeId = 155;

  @override
  ScfInfoModel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, ScfInfoModel obj) {
    writer
      ..writeByte(12)
      ..writeByte(0)
      ..write(obj.transNo)

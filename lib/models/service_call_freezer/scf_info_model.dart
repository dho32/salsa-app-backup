...
part 'scf_info_model.g.dart';

// --- TYPE ID: 155 --- (info level-transaksi Service Call Freezer: PIC toko +
// teknisi bertugas). Pola sama dengan ProofOfServiceFreezerInfoModel.
// Implements IPicPhotoStorable supaya box-nya bisa dipakai LocationValidationBloc
// (foto lokasi/PIC saat OTP).
@HiveType(typeId: 155)
class ScfInfoModel extends HiveObject implements IPicPhotoStorable {
  @override
  @HiveField(0)
  String transNo;

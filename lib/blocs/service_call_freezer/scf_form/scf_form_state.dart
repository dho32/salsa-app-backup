...
/// State form level-transaksi Service Call Freezer (PIC toko + teknisi bertugas).
/// Pola PosfFormState (tanpa field suhu — pengukuran dicatat per-unit di wizard).
class ScfFormState extends Equatable {
